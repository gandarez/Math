...
{
    [TestClass]
    public class AdjacentPointsMaxDistanceUsingLinqTest
    {
        [TestMethod]
        public void WhenInputArrayWithMaxDistance5_Calcule_ThenReturn5()
        {
            var actual = new MaxDistanceUsingLinq().Calculate(new[] { 0, 3, 3, 12, 5, 3, 7, 1 });
        ...
        {
            var actual = new MaxDistanceUsingLinq().Calculate(new[] { 1, 1, 4, 5, 8, 2, 12 });
        ...
        {
            var actual = new MaxDistanceUsingLinq().Calculate(new[] { 1, 1, 4, 17, 99 });
        ...
        {
            var actual = new MaxDistanceUsingLinq().Calculate(new[] { -3, -5, 8, -2, 12 });
        ...
        {
            var actual = new MaxDistanceUsingLinq().Calculate(new[] { 1, 1, 1, 1 });
        ...
        {
            var actual = new MaxDistanceUsingLinq().Calculate(new[] { -5, -5, -5 });
            Assert.AreEqual(-2, actual);
        }
        ...
        {
            new MaxDistanceUsingLinq().Calculate(new int[] { });
        }
        ...
        {
            new MaxDistanceUsingLinq().Calculate(new int[40001]);
        }
        ...
        {
            new MaxDistanceUsingLinq().Calculate(null);
        }
    }
}